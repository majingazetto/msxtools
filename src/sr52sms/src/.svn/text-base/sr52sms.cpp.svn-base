...
void logo ()
{
    fprintf(stdout,"SR52SMS Tile Convert Utility v 0.0 (c) 2010 Ramones\n\n");
}
...
void usage()
{
    fprintf(stdout,"Usage : sr52sms image.sr5 initline lines (default 0 24) \n\n");
    fprintf(stdout,"    initline: First line to extract data (0-23)\n");
    fprintf(stdout,"    lines: Number of lines to extract data (1-26)\n\n");
...
s32 savefile(s8* outputname, s32 lines, u8* convertdata)
{
    ...
    fwrite(convertdata,sizeof(u8),lines*32*32,pFile);
    fflush(pFile);
    fclose(pFile);
    return 1;
}
...
s32 main (s32 argc, s8** argv)
{
    ...
    if (argc > 2) 
    {
        ...
        {
            fprintf(stdout,"ERROR!! initline param (0-23) \n\n");
            return -1;
        }
        ...
        if (argc > 3)
        {
            ...
            {
                fprintf(stdout,"ERROR!! lines param (1-26) \n\n");
                return -1;
